...
MERGE (user1)<-[:LIKED_BY]-(photo1)
MERGE (user2)<-[:LIKED_BY]-(photo1)
MERGE (user3)<-[:LIKED_BY]-(photo1)
MERGE (user4)<-[:LIKED_BY]-(photo1)
MERGE (user5)<-[:LIKED_BY]-(photo1)
MERGE (user3)<-[:LIKED_BY]-(photo2)
MERGE (user2)<-[:LIKED_BY]-(photo2)
MERGE (user4)<-[:LIKED_BY]-(photo2)
MERGE (user5)<-[:LIKED_BY]-(photo2)
MERGE (user4)<-[:LIKED_BY]-(photo3)
MERGE (user5)<-[:LIKED_BY]-(photo4)
MERGE (user2)<-[:LIKED_BY]-(photo4)
MERGE (user3)<-[:LIKED_BY]-(photo5)
MERGE (user4)<-[:LIKED_BY]-(photo5)
MERGE (user4)<-[:LIKED_BY]-(photo6)
MERGE (user4)<-[:LIKED_BY]-(photo7)
MERGE (user4)<-[:LIKED_BY]-(photo8)
MERGE (user4)<-[:LIKED_BY]-(photo9)
MERGE (user4)<-[:LIKED_BY]-(photo10)
